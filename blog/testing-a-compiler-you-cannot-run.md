...
_BankLang grades each of its examples by what its evidence establishes, and the
grades are generated by counting rather than asserted.
[The table is here](https://github.com/MWH997/banklang/blob/main/evidence/GRADES.md),
and [the limits are here](../docs/status-and-limits.md)._
