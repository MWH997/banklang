...
//INTCALC JOB (BANKLANG),'INT-CALC',
//             CLASS=A,MSGCLASS=X,NOTIFY=&SYSUID,REGION=0M
//* Compile, link-edit, and run the generated COBOL program.
//* Source member:   BANKLANG.COBOL(INTCALC)
//* Load module:     BANKLANG.LOADLIB(INTCALC)
...
//             PGMLIB='BANKLANG.LOADLIB',GOPGM=INTCALC
//COBOL.SYSIN    DD DISP=SHR,DSN=BANKLANG.COBOL(INTCALC)
//LKED.SYSLIB    DD DISP=SHR,DSN=BANKLANG.OBJLIB
//               DD DISP=SHR,DSN=CEE.SCEELKEX
//               DD DISP=SHR,DSN=CEE.SCEELKED
//RUN      EXEC PGM=INTCALC,
//             REGION=0M,COND=(4,LT)
