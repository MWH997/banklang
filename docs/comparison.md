...
4. **There is no test framework for the source.** `docs/integrations/
zunit-integration.md` describes what one would look like; nothing generates
   it yet. You test the generated program the way you test any COBOL program.
