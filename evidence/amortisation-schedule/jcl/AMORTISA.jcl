...
//AMORTISA JOB (BANKLANG),'AMORTISATION-SCHEDULE',
//             CLASS=A,MSGCLASS=X,NOTIFY=&SYSUID,REGION=0M
//* Compile, link-edit, and run the generated COBOL program.
//* Source member:   BANKLANG.COBOL(AMORTISA)
//* Load module:     BANKLANG.LOADLIB(AMORTISA)
...
//             PGMLIB='BANKLANG.LOADLIB',GOPGM=AMORTISA
//COBOL.SYSIN    DD DISP=SHR,DSN=BANKLANG.COBOL(AMORTISA)
