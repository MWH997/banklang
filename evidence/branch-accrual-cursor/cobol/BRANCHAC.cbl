...
CBL RENT,NODYNAM,QUOTE,PGMNAME(COMPAT)
      ...
      *> ---------------------------------------------------------------
       ...
       PROCEDURE DIVISION.
       DECLARATIVES.
       SUMMARY-OUTPUT-ERROR-SECTION SECTION.
           USE AFTER STANDARD ERROR PROCEDURE ON SUMMARY-OUTPUT-FILE.
       SUMMARY-OUTPUT-ERROR.
           DISPLAY "SUMMARYOUTPUT FAILED, STATUS " SUMMARY-STATUS UPON
               SYSOUT
           MOVE 12 TO BANK-RETURN-CODE
           CONTINUE.
       RESTART-FILE-ERROR-SECTION SECTION.
           USE AFTER STANDARD ERROR PROCEDURE ON RESTART-FILE-FILE.
       RESTART-FILE-ERROR.
           DISPLAY "RESTARTFILE FAILED, STATUS " RESTART-STATUS UPON
               SYSOUT
           MOVE 12 TO BANK-RETURN-CODE
           CONTINUE.
       END DECLARATIVES.
       ...
       BANK-MAIN.
           ...
           IF BANK-FILE-OPEN-2 = "Y"
               ...
               IF NOT RESTART-STATUS-OK
                   DISPLAY "CLOSE FAILED restartFile STATUS "
                       RESTART-STATUS UPON SYSOUT
                   MOVE 12 TO BANK-RETURN-CODE
                   IF BANK-FAILURE-CODE = SPACES
                       MOVE "CLOSE-FAILED" TO BANK-FAILURE-CODE
                   END-IF
