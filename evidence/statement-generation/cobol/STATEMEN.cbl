...
CBL RENT,NODYNAM,QUOTE,PGMNAME(COMPAT)
      ...
      *> ---------------------------------------------------------------
       ...
       ACCOUNT-MASTER-ERROR.
           DISPLAY "ACCOUNTMASTER FAILED, STATUS " ACCOUNT-MASTER-STATUS
               UPON SYSOUT
           MOVE 12 TO BANK-RETURN-CODE
           CONTINUE.
       STATEMENT-OUTPUT-ERROR-SECTION SECTION.
           USE AFTER STANDARD ERROR PROCEDURE ON STATEMENT-OUTPUT-FILE.
       STATEMENT-OUTPUT-ERROR.
           DISPLAY "STATEMENTOUTPUT FAILED, STATUS "
       ...
       BANK-MAIN.
           ...
           IF BANK-FILE-OPEN-2 = "Y"
               ...
               IF NOT STATEMENT-OUTPUT-STATUS-OK
                   DISPLAY "CLOSE FAILED statementOutput STATUS "
                       STATEMENT-OUTPUT-STATUS UPON SYSOUT
                   MOVE 12 TO BANK-RETURN-CODE
                   IF BANK-FAILURE-CODE = SPACES
                       MOVE "CLOSE-FAILED" TO BANK-FAILURE-CODE
       ...
       GENERATE-STATEMENT-BODY.
           ...
           IF ACCOUNT-MASTER-STATUS NOT = "00"
               DISPLAY "NO MASTER RECORD FOR " ACCOUNT-ID OF STATEMENT
                   UPON SYSOUT
               CLOSE ACCOUNT-MASTER-FILE
               IF NOT ACCOUNT-MASTER-STATUS-OK
                   DISPLAY "CLOSE FAILED accountMaster STATUS "
               ...
               END-IF
               MOVE "N" TO BANK-FILE-OPEN-1
               MOVE "NO_ACCOUNT" TO BANK-FAILURE-CODE
               GO TO GENERATE-STATEMENT-BODY-EXIT
           END-IF
