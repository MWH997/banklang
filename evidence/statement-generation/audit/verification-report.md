...
Project: /workspace/examples/statement-generation/src/main.bank.ts
Version: 1
...
| COBOL emit                 | passed  | /workspace/dist/cobol/STATEMENT-GENERATION.cbl                                  |
| Copybook emit              | passed  | 3 copybook file(s)                                                              |
| Source map emit            | passed  | /workspace/dist/maps/source-map.json                                            |
| JCL emit                   | passed  | /workspace/dist/jcl/STATEMENT-GENERATION.jcl                                    |
