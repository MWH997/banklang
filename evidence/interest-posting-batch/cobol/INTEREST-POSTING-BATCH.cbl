...
*> Source maps are available in dist/maps.
       ...
       RUN-BATCH.
           ...
           PERFORM UNTIL WS-LOOP-90-3 >= 100000 OR NOT (ACCOUNT-FEED-STATUS = "00")
               ...
               END-READ
               MOVE ACCOUNT-ID OF ACCOUNT-FEED-RECORD TO ACCOUNT-ID OF INTEREST-ACCOUNT
               MOVE BRANCH-CODE OF ACCOUNT-FEED-RECORD TO BRANCH-CODE OF INTEREST-ACCOUNT
               MOVE BALANCE OF ACCOUNT-FEED-RECORD TO BALANCE OF INTEREST-ACCOUNT
               MOVE ACCRUED-INTEREST OF ACCOUNT-FEED-RECORD TO ACCRUED-INTEREST OF INTEREST-ACCOUNT
               MOVE IDEMPOTENCY-KEY OF ACCOUNT-FEED-RECORD TO IDEMPOTENCY-KEY OF INTEREST-ACCOUNT
               MOVE ACCOUNT-ID OF POSTING-ADVICE TO ACCOUNT-ID OF ADVICE-OUTPUT-RECORD
               MOVE INTEREST-AMOUNT OF POSTING-ADVICE TO INTEREST-AMOUNT OF ADVICE-OUTPUT-RECORD
               MOVE IDEMPOTENCY-KEY OF POSTING-ADVICE TO IDEMPOTENCY-KEY OF ADVICE-OUTPUT-RECORD
