...
//INTEREST JOB (BANKLANG),'INTEREST-POSTING-BATCH',
//             CLASS=A,MSGCLASS=X,NOTIFY=&SYSUID,REGION=0M
//* Compile, link-edit, and run the generated COBOL program.
//* Source member:   BANKLANG.COBOL(INTEREST)
//* Load module:     BANKLANG.LOADLIB(INTEREST)
...
//             PGMLIB='BANKLANG.LOADLIB',GOPGM=INTEREST
//COBOL.SYSIN    DD DISP=SHR,DSN=BANKLANG.COBOL(INTEREST)
...
//ADVICEOU DD DSN=BANKLANG.ADVICEOU,DISP=(NEW,CATLG,DELETE),
