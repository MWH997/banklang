...
Project: examples/account-transfer/src/main.bank.ts
Version: 1
...
| COBOL emit | passed | evidence/account-transfer/cobol/ACCOUNTT.cbl |
| Copybook emit | passed | 1 copybook file(s) |
| Source map emit | passed | evidence/account-transfer/maps/source-map.json |
| JCL emit | passed | evidence/account-transfer/jcl/ACCOUNTT.jcl |
| Audit artifacts | passed | evidence/account-transfer/audit |
