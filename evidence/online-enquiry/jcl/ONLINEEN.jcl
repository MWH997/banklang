...
//ONLINEEN JOB (BANKLANG),'ONLINE-ENQUIRY',
//             CLASS=A,MSGCLASS=X,NOTIFY=&SYSUID,REGION=0M
//* Build job for the generated CICS program. It is installed, not run.
//* Source member:   BANKLANG.COBOL(ONLINEEN)
//* Load module:     BANKLANG.LOADLIB(ONLINEEN)
...
//SYSPRINT DD SYSOUT=*
//SYSIN    DD DISP=SHR,DSN=BANKLANG.COBOL(ONLINEEN)
...
//DBRMLIB  DD DISP=SHR,DSN=BANKLANG.DBRMLIB(ONLINEEN)
//SYSPRINT DD SYSOUT=*
...
//SYSLMOD  DD DSN=BANKLANG.LOADLIB(ONLINEEN),
//            SPACE=(CYL,(3,1,1)),
...
//SYSTSIN  DD *
  ...
  BIND PLAN(ONLINEEN) PKLIST(BANKLANG.*) ACT(REP) ISO(CS)
  END
/*
