...
//ACCOUNTP JOB (BANKLANG),'ACCOUNT-POSTING',
//             CLASS=A,MSGCLASS=X,NOTIFY=&SYSUID,REGION=0M
//* Compile, link-edit, and run the generated COBOL program.
//* Source member:   BANKLANG.COBOL(ACCOUNTP)
//* Load module:     BANKLANG.LOADLIB(ACCOUNTP)
...
//             PGMLIB='BANKLANG.LOADLIB',GOPGM=ACCOUNTP
//COBOL.SYSIN    DD DISP=SHR,DSN=BANKLANG.COBOL(ACCOUNTP)
