 ...
 * not TypeScript. Nothing imports one, since every test reads them as text, but a
...
export default defineConfig({
  test: {
     ...
     * for the machine with every other worker, rather than by anything the assertion
     ...
     *
     * The work itself was cut first, and the reference runtime is now compiled
     * once rather than six times per test, so this covers what is left. It is
